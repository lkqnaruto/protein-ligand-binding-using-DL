...
class CustomDatasetDataLoader():
    ...
    def __init__(self, opt):
        ...
        self.all_points = getattr(self.dataset, 'all_points')
        self.selected_ligand_atom_pair = getattr(self.dataset, 'selected_ligand_atom_pair')
        # self.dataset = dataset(opt.dataroot)
    ...
    def __iter__(self):
        ...
        loop = tqdm.tqdm(self.dataloader)
