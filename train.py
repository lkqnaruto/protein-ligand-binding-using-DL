...
if __name__ == '__main__':
    ...
    # print('generator A: ', model.__dict__['netG_A'])
    # print('generator B: ', model.__dict__['netG_B'])
    # print(model.__dict__['netD_A'])
    # sys.exit()
    ...
    for epoch in range(opt.epoch_count, opt.n_epochs + opt.n_epochs_decay + 1):    # outer loop for different epochs; we save the model by <epoch_count>, <epoch_count>+<save_latest_freq>
        ...
        if (epoch >= 30) and (epoch % opt.save_epoch_freq == 0):              # cache our model every <save_epoch_freq> epochs
